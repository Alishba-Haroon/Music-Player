...
rootpath = r""  # or "<SONG_PATH>"
pattern = "*.mp3"

mixer.init()

prev_img = tk.PhotoImage(file = r"") # Image path  
stop_img = tk.PhotoImage(file = r"") # Image path  
play_img = tk.PhotoImage(file = r"") # Image path  
pause_img = tk.PhotoImage(file = "") # Image path  
next_img = tk.PhotoImage(file = r"") # Image path  
